...
@njit
def compute_cauchy_green(flow_map_jacobian: ArrayFloat32Nx2x2):
...
@njit
def max_eigenvalue_2x2(cauchy_green_tensor: ArrayFloat32Nx2x2):
    """Compute the maximum eigenvalue for each 2×2 Cauchy-Green tensor."""
